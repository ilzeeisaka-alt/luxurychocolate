...
const navItems: Record<Lang, NavItem[]> = expandLangs({
  lv: [
    ...
    { label: "Kāzu šokolādes", to: "#kazu" },
    { label: "Kapkeiki", to: "#kapkeiki" },
  ...
  en: [
    ...
    { label: "Wedding Chocolates", to: "#kazu" },
    { label: "Cupcakes", to: "#kapkeiki" },
  ...
  ru: [
    ...
    { label: "Свадебный шоколад", to: "#kazu" },
    { label: "Капкейки", to: "#kapkeiki" },
    { label: "Affiliate", to: "/affiliate" },
  ...
  et: [
    ...
    { label: "Pulmašokolaad", to: "#kazu" },
    { label: "Kapkeigid", to: "#kapkeiki" },
    { label: "Affiliate", to: "/affiliate" },
  ...
  lt: [
    ...
    { label: "Vestuvių šokoladas", to: "#kazu" },
    { label: "Keksiukai", to: "#kapkeiki" },
    { label: "Affiliate", to: "/affiliate" },
  ...
  no: [
    ...
    { label: "Bryllupssjokolade", to: "#kazu" },
    { label: "Cupcakes", to: "#kapkeiki" },
    { label: "Affiliate", to: "/affiliate" },
    { label: "Kontakt", to: "#kontakti" },
  ],
    ...
    { label: "Häät­suklaa", to: "#kazu" },
    { label: "Kuppikakut", to: "#kapkeiki" },
    { label: "Affiliate", to: "/affiliate" },
  ...
  da: [
    ...
    { label: "Bryllupschokolade", to: "#kazu" },
    { label: "Cupcakes", to: "#kapkeiki" },
    { label: "Affiliate", to: "/affiliate" },
    { label: "Kontakt", to: "#kontakti" },
  ],
  de: [
    ...
    { label: "Hochzeitsschokolade", to: "#kazu" },
    { label: "Cupcakes", to: "#kapkeiki" },
    { label: "Affiliate", to: "/affiliate" },
    { label: "Kontakt", to: "#kontakti" },
  ],
  fr: [
    ...
    { label: "Chocolat de mariage", to: "#kazu" },
    { label: "Cupcakes", to: "#kapkeiki" },
    { label: "Affiliate", to: "/affiliate" },
    { label: "Contact", to: "#kontakti" },
  ],
  it: [
    ...
    { label: "Cioccolato matrimonio", to: "#kazu" },
    { label: "Cupcake", to: "#kapkeiki" },
    { label: "Affiliate", to: "/affiliate" },
  ...
  es: [
    ...
    { label: "Chocolate de boda", to: "#kazu" },
    { label: "Cupcakes", to: "#kapkeiki" },
    { label: "Affiliate", to: "/affiliate" },
  ...
  ar: [
    ...
    { label: "شوكولاتة الزفاف", to: "#kazu" },
    { label: "كب كيك", to: "#kapkeiki" },
    { label: "Affiliate", to: "/affiliate" },
  ...
  nl: [
    ...
    { label: "Bruiloftchocolade", to: "#kazu" },
    { label: "Cupcakes", to: "#kapkeiki" },
    { label: "Affiliate", to: "/affiliate" },
    { label: "Contact", to: "#kontakti" },
  ],
  pl: [
    ...
    { label: "Czekolada ślubna", to: "#kazu" },
    { label: "Babeczki", to: "#kapkeiki" },
    { label: "Affiliate", to: "/affiliate" },
    { label: "Kontakt", to: "#kontakti" },
  ],
  cs: [
    ...
    { label: "Svatební čokoláda", to: "#kazu" },
    { label: "Cupcakes", to: "#kapkeiki" },
    { label: "Affiliate", to: "/affiliate" },
    { label: "Kontakt", to: "#kontakti" },
  ],
  pt: [
    ...
    { label: "Chocolate de casamento", to: "#kazu" },
    { label: "Cupcakes", to: "#kapkeiki" },
    { label: "Affiliate", to: "/affiliate" },
    { label: "Contacto", to: "#kontakti" },
  ],
  ...
  tr: [
    ...
    { label: "Düğün çikolatası", to: "#kazu" },
    { label: "Cupcake", to: "#kapkeiki" },
    { label: "Affiliate", to: "/affiliate" },
  ...
  hu: [
    ...
    { label: "Esküvői csokoládé", to: "#kazu" },
    { label: "Muffinok", to: "#kapkeiki" },
    { label: "Affiliate", to: "/affiliate" },
  ...
  ro: [
    ...
    { label: "Ciocolată de nuntă", to: "#kazu" },
    { label: "Cupcakes", to: "#kapkeiki" },
    { label: "Affiliate", to: "/affiliate" },
    { label: "Contact", to: "#kontakti" },
  ],
  bg: [
    ...
    { label: "Сватбен шоколад", to: "#kazu" },
    { label: "Къпкейкове", to: "#kapkeiki" },
    { label: "Affiliate", to: "/affiliate" },
  ...
  hr: [
    ...
    { label: "Vjenčana čokolada", to: "#kazu" },
    { label: "Cupcakes", to: "#kapkeiki" },
    { label: "Affiliate", to: "/affiliate" },
    { label: "Kontakt", to: "#kontakti" },
  ],
  sk: [
    ...
    { label: "Krabičky", to: "#magnets" },
    { label: "Mince", to: "#monetas" },
    { label: "Svadobná čokoláda", to: "#kazu" },
    { label: "Cupcakes", to: "#kapkeiki" },
    { label: "Affiliate", to: "/affiliate" },
    { label: "Kontakt", to: "#kontakti" },
  ],
  sl: [
    ...
    { label: "Poročna čokolada", to: "#kazu" },
    { label: "Kolački", to: "#kapkeiki" },
    { label: "Affiliate", to: "/affiliate" },
    { label: "Kontakt", to: "#kontakti" },
  ],
  uk: [
    ...
    { label: "Коробки", to: "#magnets" },
    { label: "Монети", to: "#monetas" },
    { label: "Весільний шоколад", to: "#kazu" },
    { label: "Капкейки", to: "#kapkeiki" },
    { label: "Affiliate", to: "/affiliate" },
    { label: "Контакти", to: "#kontakti" },
  ],
  sr: [
    ...
    { label: "Венчана чоколада", to: "#kazu" },
    { label: "Капкејкови", to: "#kapkeiki" },
    { label: "Affiliate", to: "/affiliate" },
    { label: "Kontakt", to: "#kontakti" },
  ],
  bs: [
  ...
  mk: [
    ...
    { label: "Кутии", to: "#magnets" },
    { label: "Монети", to: "#monetas" },
    { label: "Свадбено чоколадо", to: "#kazu" },
    { label: "Капкејкс", to: "#kapkeiki" },
    { label: "Affiliate", to: "/affiliate" },
  ...
  is: [
    ...
    { label: "Brúðkaupssúkkulaði", to: "#kazu" },
    { label: "Cupcakes", to: "#kapkeiki" },
    { label: "Affiliate", to: "/affiliate" },
