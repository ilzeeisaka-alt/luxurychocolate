...
import fortuneBagged from "@/assets/fortune-cookies/fortune-cookies-bagged.jpg";

const images = [fortuneBagged];
const items = [
  {
    title: "Laimes Cepums 12 cm maisiņā ar lentīti",
    description: "Klasisks laimes cepums ar Jūsu personalizētu vēstījumu, iesaiņots caurspīdīgā maisiņā ar sarkanu satīna lentīti — eleganta dāvana viesiem un klientiem.",
    alt: "Laimes cepumi caurspīdīgā maisiņā ar sarkanu lentīti",
  },
];
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl text-foreground mb-4">
              Laimes Cepumi ar personalizētu vēstījumu
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Klasiskie laimes cepumi (fortune cookies) ar Jūsu izvēlētu vēstījumu iekšpusē.
              Ideāli pasākumiem, viesu dāvanām, restorāniem un korporatīvām aktivitātēm.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12 max-w-5xl mx-auto items-start">
            ...
            >
              <div className="relative aspect-[9/16] w-full">
                <iframe
                  src="https://www.youtube.com/embed/--nKDFtbCwc"
                  title="Laimes Cepumi video"
              ...
              <div className="p-3">
                <p className="text-sm font-medium text-foreground">Laimes Cepumi — video</p>
              </div>
            </motion.div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {[
              { title: "Personalizēts vēstījums", desc: "Jūsu teksts vai zīmola ziņojums katrā cepumā" },
              { title: "Elegants iepakojums", desc: "Caurspīdīgs maisiņš ar sarkanu satīna lentīti" },
              { title: "12 cm izmērs", desc: "Klasisks lielums — perfekts viesu dāvanai" },
            ].map((f) => (
              <div
                key={f.title}
...
export default FortuneCookieSection;
