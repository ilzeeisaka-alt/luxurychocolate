...
const ZhIndex = lazy(() => import("./pages/ZhIndex.tsx"));
const JaIndex = lazy(() => import("./pages/JaIndex.tsx"));
const KoIndex = lazy(() => import("./pages/KoIndex.tsx"));
const HiIndex = lazy(() => import("./pages/HiIndex.tsx"));
const BnIndex = lazy(() => import("./pages/BnIndex.tsx"));
const UrIndex = lazy(() => import("./pages/UrIndex.tsx"));
const FaIndex = lazy(() => import("./pages/FaIndex.tsx"));
const HeIndex = lazy(() => import("./pages/HeIndex.tsx"));
const ThIndex = lazy(() => import("./pages/ThIndex.tsx"));
const ViIndex = lazy(() => import("./pages/ViIndex.tsx"));
const IdIndex = lazy(() => import("./pages/IdIndex.tsx"));
const MsIndex = lazy(() => import("./pages/MsIndex.tsx"));
const TlIndex = lazy(() => import("./pages/TlIndex.tsx"));
const SwIndex = lazy(() => import("./pages/SwIndex.tsx"));
const AmIndex = lazy(() => import("./pages/AmIndex.tsx"));
const KaIndex = lazy(() => import("./pages/KaIndex.tsx"));
const AzIndex = lazy(() => import("./pages/AzIndex.tsx"));
const KkIndex = lazy(() => import("./pages/KkIndex.tsx"));
const HyIndex = lazy(() => import("./pages/HyIndex.tsx"));
const BeIndex = lazy(() => import("./pages/BeIndex.tsx"));
const TaIndex = lazy(() => import("./pages/TaIndex.tsx"));
const KmIndex = lazy(() => import("./pages/KmIndex.tsx"));
const MnIndex = lazy(() => import("./pages/MnIndex.tsx"));
      ...
      <BrowserRouter>
        ...
        <Suspense fallback={<div className="min-h-screen bg-background" />}>
          <Routes>
            ...
            <Route path="/noteikumi" element={<ContentPage slug="noteikumi" />} />
            <Route path="/terms" element={<ContentPage slug="noteikumi" />} />
            ...
            {/* Asian & extended routes */}
            <Route path="/zh" element={<ZhIndex />} />
            <Route path="/ja" element={<JaIndex />} />
            <Route path="/ko" element={<KoIndex />} />
            <Route path="/hi" element={<HiIndex />} />
            <Route path="/bn" element={<BnIndex />} />
            <Route path="/ur" element={<UrIndex />} />
            <Route path="/fa" element={<FaIndex />} />
            <Route path="/he" element={<HeIndex />} />
            <Route path="/th" element={<ThIndex />} />
            <Route path="/vi" element={<ViIndex />} />
            <Route path="/id" element={<IdIndex />} />
            <Route path="/ms" element={<MsIndex />} />
            <Route path="/tl" element={<TlIndex />} />
            <Route path="/sw" element={<SwIndex />} />
            <Route path="/am" element={<AmIndex />} />
            <Route path="/ka" element={<KaIndex />} />
            <Route path="/az" element={<AzIndex />} />
            <Route path="/kk" element={<KkIndex />} />
            <Route path="/hy" element={<HyIndex />} />
            <Route path="/be" element={<BeIndex />} />
            <Route path="/ta" element={<TaIndex />} />
            <Route path="/km" element={<KmIndex />} />
            <Route path="/mn" element={<MnIndex />} />
            {/* LV blog */}
