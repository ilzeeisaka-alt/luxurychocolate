...
const MkIndex = () => {
  ...
  useSeo({
    title: "Печат на чоколадо & Персонализирано чоколадо со лого",
    description: "Печат на чоколадо — полноколорен печат директно врз белгиско чоколадо. Персонализирано чоколадо со лого, корпоративни подароци.",
    path: "/mk",
  });
  ...
  return (
    <main className="bg-background pt-14 lg:pt-24">
      ...
      <CelebrationCakeSection lang="mk" onCtaClick={() => setModalOpen(true)} />
      <MagnetBoxSection lang="mk" />
      <CoinsCardsSection lang="mk" onCtaClick={() => setModalOpen(true)} />
