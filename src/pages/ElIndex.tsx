...
const ElIndex = () => {
  ...
  useSeo({
    title: "Εκτύπωση σε σοκολάτα & Εξατομικευμένη σοκολάτα με λογότυπο",
    description: "Εκτύπωση σε σοκολάτα — πλήρης έγχρωμη εκτύπωση απευθείας σε βελγική σοκολάτα. Εξατομικευμένη σοκολάτα με λογότυπο, εταιρικά δώρα.",
    path: "/el",
  });
  ...
  return (
    <main className="bg-background pt-14 lg:pt-24">
      ...
      <MagnetBoxSection lang="el" />
      <CoinsCardsSection lang="el" onCtaClick={() => setModalOpen(true)} />
