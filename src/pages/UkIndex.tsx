...
const UkIndex = () => {
  ...
  useSeo({
    title: "Друк на шоколаді & Персоналізований шоколад з логотипом",
    description: "Друк на шоколаді — повнокольоровий друк безпосередньо на бельгійському шоколаді. Персоналізований шоколад з логотипом, корпоративні подарунки.",
    path: "/uk",
  });
  ...
  return (
    <main className="bg-background pt-14 lg:pt-24">
      ...
      <CelebrationCakeSection lang="uk" onCtaClick={() => setModalOpen(true)} />
      <MagnetBoxSection lang="uk" />
      <CoinsCardsSection lang="uk" onCtaClick={() => setModalOpen(true)} />
