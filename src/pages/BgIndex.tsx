...
const BgIndex = () => {
  ...
  useSeo({
    title: "Печат върху шоколад & Персонализиран шоколад с лого",
    description: "Печат върху шоколад — пълноцветен печат директно върху белгийски шоколад. Персонализиран шоколад с лого, корпоративни подаръци.",
    path: "/bg",
  });
