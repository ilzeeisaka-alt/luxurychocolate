...
const RuIndex = () => {
  ...
  useSeo({
    title: "Печать на шоколаде & Персонализированный шоколад с логотипом",
    description: "Печать на шоколаде — полноцветная печать прямо на бельгийском шоколаде. Персонализированный шоколад с логотипом, корпоративные подарки.",
    path: "/ru",
  });
  ...
  return (
    <main className="bg-background pt-14 lg:pt-24">
      ...
      <MagnetBoxSection lang="ru" />
      <CoinsCardsSection lang="ru" onCtaClick={() => setModalOpen(true)} />
