...
const ArIndex = () => {
  ...
  useSeo({
    title: "الطباعة على الشوكولاتة وشوكولاتة مخصصة بشعار",
    description: "الطباعة على الشوكولاتة — طباعة كاملة الألوان مباشرة على الشوكولاتة البلجيكية. شوكولاتة مخصصة بشعار، هدايا الشركات.",
    path: "/ar",
  });
  ...
  return (
    <main className="bg-background pt-14 lg:pt-24">
      ...
      <CoinsCardsSection lang="ar" onCtaClick={() => setModalOpen(true)} />
