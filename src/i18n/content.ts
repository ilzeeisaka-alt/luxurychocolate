...
export const heroContent: Record<Lang, { title1: string; title2: string; subtitle: string; ctaButton: string; formButton: string; pricesButton: string }> = addNewLangs({
  ...
  lt: { title1: "Ekskluzyvinis šokoladas su logotipu", title2: "ir korporatyvinės dovanos", subtitle: "Personalizuotas reklaminis šokoladas — rankų darbo iš belgiško šokolado", ctaButton: "Nemokama dizaino peržiūra", formButton: "Užpildyti paraišką", pricesButton: "Kainos" },
