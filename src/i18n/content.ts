...
export const seoContent: Record<Lang, { heading: string; paragraphs: { text: string; links?: { text: string; to: string }[] }[] }> = addNewLangs({
  lv: {
    ...
    paragraphs: [
      ...
      { text: "Uzņēmumi bieži izmanto šokolādes ar apdruku dažādos biznesa pasākumos — konferencēs, izstādēs, klientu tikšanās reizēs. Īpaši populāri ir {link1}, kā arī {link2} svētku sezonā.", links: [{ text: "reklāmas saldumi izstādēm un konferencēm", to: "/reklamas-sokolade" }, { text: "Ziemassvētku korporatīvās šokolādes", to: "/ziemassvetku-korporativas-sokolades" }] },
      { text: "Mēs piedāvājam premium kvalitātes šokolādes ar personalizētu apdruku, kas pielāgota Jūsu uzņēmuma logo, krāsām un dizainam. Šokolādes var izmantot gan kā reklāmas dāvanas, gan kā {link1}.", links: [{ text: "ekskluzīvas korporatīvās dāvanas klientiem ar logo", to: "/sokolades-klientu-davanam" }] },
      { text: "Mūsu piedāvājumā ietilpst arī personalizēta šokolāde biznesa partneru sveikšanai, oriģinālas dāvanas sadarbības partneriem svētkos, kā arī beļģu šokolādes dāvanu komplekti ar piegādi visā Latvijā. Šokolāde ar logo pasūtījums no 1 gabala — mēs nodrošinām ātra korporatīvo dāvanu izgatavošana 3 darba dienās un bezmaksas dizaina skices korporatīvajām dāvanām." },
      { text: "Specifisku pasākumu vajadzībām piedāvājam arī {link1} un logo, personalizētas konfekšu kastes uzņēmuma jubilejai, premium dāvanu grozi ar beļģu šokolādi, kā arī individuāla dizaina {link2}.", links: [{ text: "šokolādes grāmata ar magnētisko aizdari", to: "/sokolades-gramata" }, { text: "šokolādes dekori desertiem", to: "/sokolade-pie-kafijas" }] },
    ],
  },
  en: {
...
export const heroContent: Record<Lang, { title1: string; title2: string; subtitle: string; tagline: string; ctaButton: string; formButton: string; pricesButton: string }> = addNewLangs({
  lv: { title1: "Ekskluzīva šokolāde ar logo", title2: "un premium korporatīvās dāvanas", subtitle: "Personalizētas reklāmas šokolādes — roku darbs no Beļģu šokolādes", tagline: "Šokolādes tiešā apdruka uzņēmumu brenda popularizēšanai — uzdruka ar šokolādes krāsām uz šokolādes", ctaButton: "Bezmaksas dizaina apskate", formButton: "Aizpildīt pieteikumu", pricesButton: "Cenas" },
  en: { title1: "Exclusive Chocolate with Logo", title2: "& Corporate Gifts", subtitle: "Personalized Promotional Chocolates — Custom Hand Made from Belgian Chocolate", tagline: "Direct chocolate printing for corporate brand promotion — printed with chocolate colors on chocolate", ctaButton: "Free design preview", formButton: "Fill in the form", pricesButton: "Prices" },
  ru: { title1: "Эксклюзивный шоколад с логотипом", title2: "и корпоративные подарки", subtitle: "Персонализированный рекламный шоколад — ручная работа из бельгийского шоколада", tagline: "Прямая печать на шоколаде для продвижения корпоративного бренда — печать шоколадными красками по шоколаду", ctaButton: "Бесплатный макет дизайна", formButton: "Заполнить заявку", pricesButton: "Цены" },
  et: { title1: "Eksklusiivne šokolaad logoga", title2: "ja ärikingitused", subtitle: "Personaliseeritud reklaamšokolaad — käsitööna valmistatud Belgia šokolaadist", tagline: "Otsetrükk šokolaadile ettevõtte brändi reklaamimiseks — trükk šokolaadivärvidega šokolaadile", ctaButton: "Tasuta disaini eelvaade", formButton: "Täida taotlus", pricesButton: "Hinnad" },
  lt: { title1: "Ekskluzyvinis šokoladas su logotipu", title2: "ir korporatyvinės dovanos", subtitle: "Personalizuotas reklaminis šokoladas — rankų darbo iš belgiško šokolado", tagline: "Tiesioginis spausdinimas ant šokolado įmonės prekės ženklo reklamai — spaudinys šokolado spalvomis ant šokolado", ctaButton: "Nemokama dizaino peržiūra", formButton: "Užpildyti paraišką", pricesButton: "Kainos" },
  sv: { title1: "Exklusiv choklad med logotyp", title2: "& företagspresenter", subtitle: "Personlig reklamchoklad — handgjord av belgisk choklad", tagline: "Direkttryck på choklad för företagets varumärkesfrämjande — tryck med chokladfärger på choklad", ctaButton: "Gratis designförhandsvisning", formButton: "Fyll i formuläret", pricesButton: "Priser" },
  no: { title1: "Eksklusiv sjokolade med logo", title2: "& bedriftsgaver", subtitle: "Personlig reklamesjokolade — håndlaget av belgisk sjokolade", tagline: "Direkte trykk på sjokolade for bedriftens merkevarefremming — trykk med sjokoladefarger på sjokolade", ctaButton: "Gratis designforhåndsvisning", formButton: "Fyll ut skjemaet", pricesButton: "Priser" },
  fi: { title1: "Eksklusiivinen suklaa logolla", title2: "& yrityslahjat", subtitle: "Personoitu mainossuklaa — käsintehtyä belgialaisesta suklaasta", tagline: "Suoratulostus suklaalle yrityksen brändin edistämiseksi — painatus suklaaväreillä suklaalle", ctaButton: "Ilmainen esikatselu", formButton: "Täytä lomake", pricesButton: "Hinnat" },
  da: { title1: "Eksklusiv chokolade med logo", title2: "& firmapresenter", subtitle: "Personlig reklamechokolade — håndlavet af belgisk chokolade", tagline: "Direkte tryk på chokolade til virksomhedens brandpromovering — tryk med chokoladefarver på chokolade", ctaButton: "Gratis designforhåndsvisning", formButton: "Udfyld formularen", pricesButton: "Priser" },
});
...
export const restaurantChocolateContent: Record<Lang, { heading: string; subtitle: string; benefits: string[]; usageNote: string; coffeeHeading: string; coffeeSubtitle: string; items: { title: string; description: string; alt: string }[] }> = addNewLangs({
  ...
  sv: {
    ...
    items: [
      ...
      { title: "Choklad med notan", description: "Personlig choklad med restaurangnotan — ett oförglömligt sista intryck.", alt: "Fellini restaurang logotypchoklad med notan" },
  ...
  no: {
    ...
    items: [
      ...
      { title: "Suklaa laskun kanssa", description: "Personoitu suklaa ravintolalaskun kanssa — unohtumaton viimeinen vaikutelma.", alt: "Fellini ravintolan logosuklaat laskun kanssa" },
...
export const vipGiftContent: Record<Lang, {
  ...
  lv: {
    ...
    items: [
      { title: "Šokolādes pakavs Pullman viesnīcai", description: "Tumšās šokolādes pakavs ar logo organiskā stikla kastē — ekskluzīva Ziemassvētku dāvana viesnīcas viesiem.", alt: "Pullman viesnīcas šokolādes pakavs organiskā stikla kastē ar Ziemassvētku dekoru" },
      { title: "Šokolādes pakavs — tuvplāns", description: "Detalizēts tumšās šokolādes pakavs ar Pullman logo un parakstu — roku darbs.", alt: "Tuvplāns — šokolādes pakavs ar Pullman logo organiskā stikla kastē" },
      { title: "Nošu apdruka uz šokolādes", description: "Baltā šokolāde ar apdrukātām notīm organiskā stikla kastē — unikāla dāvana mūziķiem un pasākumiem.", alt: "Baltā šokolāde ar apdrukātām nošām organiskā stikla kastē pie klavierēm" },
      { title: "Nošu šokolāde — tuvplāns", description: "Raimonda Paula 'Baltā Saule' nošu apdruka uz baltās šokolādes — individuāls dizains.", alt: "Tuvplāns — nošu apdruka uz baltās šokolādes organiskā stikla kastē" },
      { title: "Zemenes šokolādē ar dekoru", description: "Svaigas zemenes šokolādē ar sirsniņām un avenēm organiskā stikla kastē ar gravētu uzrakstu.", alt: "Zemenes šokolādē ar sirsniņām organiskā stikla kastē ar gravētu 'Love is like fire'" },
  ...
  en: {
    ...
    items: [
      { title: "Chocolate horseshoe for Pullman hotel", description: "Dark chocolate horseshoe with logo in acrylic box — exclusive Christmas gift for hotel guests.", alt: "Pullman hotel chocolate horseshoe in acrylic box with Christmas decor" },
      { title: "Chocolate horseshoe — close-up", description: "Detailed dark chocolate horseshoe with Pullman logo and signature — handcrafted.", alt: "Close-up — chocolate horseshoe with Pullman logo in acrylic box" },
      { title: "Sheet music printed on chocolate", description: "White chocolate with printed musical notes in acrylic box — unique gift for musicians and events.", alt: "White chocolate with printed sheet music in acrylic box by piano" },
      { title: "Music chocolate — close-up", description: "Raimonds Pauls 'Baltā Saule' sheet music printed on white chocolate — custom design.", alt: "Close-up — sheet music print on white chocolate in acrylic box" },
      { title: "Chocolate-dipped strawberries", description: "Fresh strawberries in chocolate with hearts and berries in acrylic box with engraved text.", alt: "Chocolate-dipped strawberries with hearts in acrylic box with engraved 'Love is like fire'" },
  ...
  ru: {
    ...
    items: [
      { title: "Шоколадная подкова для Pullman", description: "Подкова из тёмного шоколада с логотипом в акриловой коробке — эксклюзивный рождественский подарок.", alt: "Шоколадная подкова Pullman в акриловой коробке" },
      { title: "Подкова — крупный план", description: "Детализированная подкова из тёмного шоколада с логотипом Pullman — ручная работа.", alt: "Крупный план шоколадной подковы с логотипом Pullman" },
      { title: "Ноты на шоколаде", description: "Белый шоколад с напечатанными нотами в акриловой коробке — уникальный подарок.", alt: "Белый шоколад с нотами в акриловой коробке у пианино" },
      { title: "Ноты — крупный план", description: "Печать нот на белом шоколаде — индивидуальный дизайн.", alt: "Крупный план нот на белом шоколаде" },
      { title: "Клубника в шоколаде", description: "Свежая клубника в шоколаде с сердечками в акриловой коробке с гравировкой.", alt: "Клубника в шоколаде с сердечками в акриловой коробке" },
  ...
  et: {
    ...
    items: [
      { title: "Šokolaadi hobuseraud Pullmanile", description: "Tumedast šokolaadist hobuseraud logoga akrüülkarbis — eksklusiivne jõulukingitus.", alt: "Pullmani šokolaadi hobuseraud akrüülkarbis" },
      { title: "Hobuseraud — lähivõte", description: "Detailne tumedast šokolaadist hobuseraud Pullmani logoga — käsitöö.", alt: "Lähivõte šokolaadi hobuserauast Pullmani logoga" },
      { title: "Noodid šokolaadil", description: "Valge šokolaad trükitud nootidega akrüülkarbis — unikaalne kingitus.", alt: "Valge šokolaad nootidega akrüülkarbis klaveri juures" },
      { title: "Noodid — lähivõte", description: "Nootide trükk valgel šokolaadil — individuaalne disain.", alt: "Lähivõte nootidest valgel šokolaadil" },
      { title: "Šokolaadiga kaetud maasikad", description: "Värsked maasikad šokolaadis südametega akrüülkarbis graveeringuga.", alt: "Šokolaadiga kaetud maasikad südametega akrüülkarbis" },
  ...
  lt: {
    ...
    items: [
      { title: "Šokolado pasaga Pullman viešbučiui", description: "Tamsaus šokolado pasaga su logotipu akrilinėje dėžutėje — ekskliuzyvus kalėdinis dovanėlė.", alt: "Pullman šokolado pasaga akrilinėje dėžutėje" },
      { title: "Pasaga — artimas vaizdas", description: "Detalizuota tamsaus šokolado pasaga su Pullman logotipu — rankų darbas.", alt: "Artimas vaizdas šokolado pasagos su Pullman logotipu" },
      { title: "Natos ant šokolado", description: "Baltas šokoladas su atspausdintomis natomis akrilinėje dėžutėje — unikali dovana.", alt: "Baltas šokoladas su natomis akrilinėje dėžutėje prie pianino" },
      { title: "Natos — artimas vaizdas", description: "Natų spauda ant balto šokolado — individualus dizainas.", alt: "Artimas vaizdas natų ant balto šokolado" },
      { title: "Braškės šokolade", description: "Šviežios braškės šokolade su širdelėmis akrilinėje dėžutėje su graviūra.", alt: "Braškės šokolade su širdelėmis akrilinėje dėžutėje" },
