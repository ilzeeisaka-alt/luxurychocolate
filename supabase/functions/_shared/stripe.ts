// Shared Stripe gateway utility for all payment edge functions.
// Routes API calls through the Lovable connector gateway.
...
// Verifies Stripe webhook signature (HMAC-SHA256) without depending on the SDK.
